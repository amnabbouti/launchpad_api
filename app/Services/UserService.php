...
class UserService extends BaseService
{
    ...
    // Update user with password hashing and role assignment
    public function updateUser(int $userId, array $data): User
    {
        // Validate first, then apply business rules
        $this->validateUserBusinessRules($data, $userId);
        $data = $this->applyUserBusinessRules($data, $userId);
    ...
    // Convert full name to first_name and last_name
     ...
     */
    private function applyUserBusinessRules(array $data, $userId = null): array
    {
