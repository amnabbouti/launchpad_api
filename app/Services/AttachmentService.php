...
class AttachmentService extends BaseService
{
    ...
    {
        return cache()->remember('attachment_type_options', 3600, function () {
            return [
    ...
    {
        return cache()->remember('attachment_supported_entity_types', 3600, function () {
            return [
                'App\\Models\\Item',
    ...
    private function validateAttachmentBusinessRules(array $data, $attachmentId = null): void
    {
        $requiredFields = [
            ...
            'org_id' => __(ErrorMessages::ATTACHMENT_ORG_REQUIRED),
        ];
        ...
        // For create operations, a file is required; for updates, it's optional
        ...
        if (isset($data['file'])) {
            ...
            // Validate file type
            if (! in_array($file->getMimeType(), AppConstants::SUPPORTED_ATTACHMENT_MIME_TYPES)) {
