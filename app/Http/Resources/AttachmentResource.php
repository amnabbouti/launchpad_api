    ...
    public function toArray(Request $request): array
    {
        $data = [
            ...
            'attached_to' => [
                ...
                'maintenances' => $this->whenLoaded('maintenances', fn () => 
                    $this->maintenances->map(fn ($maintenance) => [
                        'id' => $maintenance->public_id,
                        'remarks' => $maintenance->remarks,
                        'cost' => $maintenance->cost,
                    ])
                ),
                'check_in_outs' => $this->whenLoaded('checkInOuts', fn () => 
                    $this->checkInOuts->map(fn ($checkInOut) => [
